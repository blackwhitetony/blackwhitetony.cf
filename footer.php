    ...
    <div class="mdui-fab-dial" style="height: 0px;">
        <?php if ($this->is('post')) {?>
            ...
            <?php if (isset($this->fields->prob_url)) {?>
                <a href="<?php $this->fields->prob_url()?>" target="_blank" class="mdui-fab mdui-fab-mini mdui-ripple mdui-color-green" style="transition-delay: 15ms;" mdui-tooltip="{content: '跳转题目',position: 'left'}"><i class="mdui-icon material-icons">&#xe157;</i></a>
            <?php }?>
        <?php } elseif ($this->is('index')) { ?>
            <a href="<?php $this->options->adminUrl();?>" target="_blank" class="mdui-fab mdui-fab-mini mdui-ripple mdui-color-blue" style="transition-delay: 15ms;" mdui-tooltip="{content: '后台管理',position: 'left'}"><i class="mdui-icon material-icons">&#xe569;</i></a>
        <?php }?>    
    </div>
</div>
<script>
...
<footer class="blog-footer">
    <div class="blog-text-center">
        ...
        <br>
        thanks <a href="https://github.com/llf0703">llf</a> for supporting his fantastic <a href="https://github.com/llf0703/llf0703.com">theme</a><br>
        theme by: <a href="https://github.com/blackwhitetony/blackwhitetony.cf" target="_blank">blackwhitetony</a>
    </div>
</footer>
